...
//CONSTANTS
#define RESOURCE "/devicedata"
#define PATH "http://192.168.1.2"
#define IDLE_TIMEOUT_MS  3000      // Amount of time to wait (in milliseconds) with no data 


// Prepare the Sensirion probe
...
Sensirion probe = Sensirion(dataPin, clockPin);


//Prepare the CC3000 wifi shield
...
#define WLAN_SSID       "p.s.n."        // cannot be longer than 32 characters!
#define WLAN_PASS       "lafrikcestchik"
...
void setup() {
  ...
  */
  ...
  uint32_t myIP = 0xC0A80102;
  
  Adafruit_CC3000_Client client = cc3000.connectTCP(myIP, 8080);
  if (client.connected()) {

    char tbuffer[500];
    strcpy(tbuffer,"GET ");
    strcat(tbuffer,RESOURCE);
    strcat(tbuffer," HTTP/1.1\r\n");
    Serial.println("Connection Succeeded");
    //client.fastrprint(F("GET "));
    //client.fastrprint(RESOURCE);
    //client.fastrprint(F(" HTTP/1.1\r\n"));
    //client.fastrprint(F("Host: ")); client.fastrprint(PATH); client.fastrprint(F("\r\n"));
    //client.fastrprint(F("\r\n"));
    client.fastrprint(tbuffer);
    client.println();
  } else {
...
void loop() {
  ...
  probe.measure(&temperature, &humidity, &dewpoint);
